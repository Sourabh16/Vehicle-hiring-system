...
public class EmployeeManagement implements EmployeeManagementRemote {
    ...
    @Override
    @RolesAllowed({"ED-APP-ADMIN","ED-APP-USERS"})
    public boolean updateEmployeePassword(String empId, String newPassword, String oldPassWord) {
        return employeeFacade.updatePassword(empId, newPassword,oldPassWord);
    }
